...
> **Errata (2026-09-08):** Option A (Pezz shell) still stands. The CDDA half of this doc is **superseded**: Paprium music must follow Pocket `0.2.1` **`paprium.pcm` (PPAD)**, not Pezz WAV+`.cue`. Keep all Pocket SFX/firmware/cart overlays. See [`POCKET_CDDA_MISTER.md`](POCKET_CDDA_MISTER.md).
